...
const RightSidebarTitle = styled.h3`
  font-size: 18px; color: #ffffff; font-weight: bold; margin: 0 0 24px 0;
`;

const PopularPostItem = styled.div`
  display: flex; flex-direction: column; gap: 8px; padding-bottom: 16px; margin-bottom: 16px; border-bottom: 1px solid #2b2b30; cursor: pointer;
  &:hover { opacity: 0.8; }
...
export default function RightSidebar({ popularPosts, getCategoryName, formatDateKorean, onPostClick }: RightSidebarProps) {
    return (
        <RightSidebarWrapper>
